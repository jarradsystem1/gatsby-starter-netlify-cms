...
const StoryProjectseem = ({section, paragraph, paragraphTwo, button, image}) => {
    const storyQueryData = useStaticQuery(graphql `
        query ProjectsnsestoryDataQuery {
            homeparticledataJson(id: {eq: "particle_story_section_contnet_project_1"}) {
                id
                title
                subtitle
                path
...
export default StoryProjectseem
