...
const StoryProjectes = ({section, paragraph, paragraphTwo, button, image}) => {
    const storyQueryData = useStaticQuery(graphql `
        query ProjectseemnesstoryDataQuery {
            homeparticledataJson(id: {eq: "particle_story_section_contnet_project_3"}) {
                id
                title
                subtitle
                path
