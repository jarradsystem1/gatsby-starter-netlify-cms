...
const AwwardsWinner = ({ ProjectTypeHeading, ProjectTypeText }) => {
  const AwwardsQueryData = useStaticQuery(graphql`
    query AboutWinnersDataQuery {
      ...
      allStrapiService(limit: 4, skip: 8) {
        nodes {
          Title
          Description
        }
...
AwwardsWinner.propTypes = {
  HeadingStyle: PropTypes.object,
  TextStyle: PropTypes.object
};

AwwardsWinner.defaultProps = {
  HeadingStyle: {
    fontSize: '40px',
